...
# ==================== KEEP-ALIVE SERVER ====================
# CORREÇÃO: Mudar de Flask('') para Flask(__name__)
app = Flask(__name__)

# CORREÇÃO: Desabilitar debug mode no Render
app.config['DEBUG'] = False

# CORREÇÃO: Suprimir logs do Flask
import logging
...
# CORREÇÃO: Adicionar threaded=True e debug=False
def run():
